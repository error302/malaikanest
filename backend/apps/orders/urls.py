...
urlpatterns = [
    ...
    path('cart/merge/', CartViewSet.as_view({'post': 'merge'})),
    path('cart/coupon/apply/', CartViewSet.as_view({'post': 'apply_coupon'})),
    path('cart/coupon/remove/', CartViewSet.as_view({'post': 'remove_coupon'})),
