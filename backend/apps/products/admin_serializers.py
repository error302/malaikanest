...
class AdminCategorySerializer(serializers.ModelSerializer):
    ...
    def _download_image(self, image_url):
        ...
        try:
            ...
            if parsed.scheme in ["http", "https"] and parsed.hostname and parsed.hostname.lower() in allowed_hosts:
                ...
                logger.debug("Category image download failed: Invalid scheme or host in %s", image_url)
        except Exception:
    ...
    def _download_image(self, image_url, default_name):
        ...
        try:
            ...
            if parsed.scheme in ["http", "https"] and parsed.hostname and parsed.hostname.lower() in allowed_hosts:
                ...
                logger.debug("Product image download failed: Invalid scheme or host in %s", image_url)
        except Exception:
