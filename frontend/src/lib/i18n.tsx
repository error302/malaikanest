...
const en: Dict = {
  ...
  'cart.remove': 'Remove',
  'cart.removeTarget': 'Remove {name} from cart',
  ...
  'checkout.till': 'Lipa na M-Pesa — Till 3370347',
  'checkout.tillDesc': 'Manual Till — paste M-Pesa code',
  'checkout.paypal': 'PayPal',
  'checkout.paypalDesc': 'Pay with PayPal',
  'checkout.card': 'Card',
...
const sw: Dict = {
  ...
  'nav.contact': 'Tupate',
  'nav.blog': 'Blogu',
  'nav.thrifted': 'Mitumba',
  'nav.account': 'Akaunti',
  'nav.wishlist': 'Matamanio',
  'nav.cart': 'Kikapu',
  'nav.categories': 'Jamii',
  'nav.search': 'Tafuta',
  'nav.searchOverlayLabel': 'Tafuta bidhaa',
  'nav.searchPlaceholder': 'mfano: nguo za mtoto, chupa ya kulisha…',
  ...
  'cart.remove': 'Ondoa',
  'cart.removeTarget': 'Ondoa {name} kwenye rakibu',
  'cart.decrease': 'Punguza idadi ya {name}',
  'cart.increase': 'Ongeza idadi ya {name}',
  'cart.qty': 'Idadi',
  'cart.item': 'Bidhaa',
  'cart.items': 'Bidhaa',
  ...
  'checkout.chooseDelivery': 'Chagua chaguo la usafirishaji…',
  ...
  'checkout.till': 'Lipa na M-Pesa — Till 3370347',
  'checkout.tillDesc': 'Malipo ya Till — weka kodi ya M-Pesa',
  'checkout.paypal': 'PayPal',
  'checkout.paypalDesc': 'Lipa na PayPal',
  'checkout.card': 'Card',
