      ...
      <div className="min-h-screen bg-secondary/20 pt-24 pb-12">
        <div className="max-w-lg mx-auto px-4 text-center">
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-secondary/50">
            ...
            <h1 className="text-2xl font-semibold text-text mb-2">Message Sent!</h1>
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-secondary/50">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-cta hover:bg-cta-hover disabled:bg-gray-300 text-white font-semibold rounded-lg transition-colors"
              >
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-secondary/50">
              <h2 className="text-xl font-semibold text-text mb-6">Contact Information</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">support@malaikanest.co.ke</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">+254 726 771 321</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">Mombasa, Kenya</div>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-secondary/50">
              <h2 className="text-xl font-semibold text-text mb-4">Follow Us</h2>
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-cta/10 rounded-full flex items-center justify-center hover:bg-cta hover:text-white transition-colors">
