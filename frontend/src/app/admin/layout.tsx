    ...
    <html lang="en" className={`${playfair.variable} ${inter.variable} ${montserrat.variable}`}>
      <body className="bg-slate-50 font-sans antialiased">
        <div className="flex min-h-screen">
          <aside className="w-64 bg-white shadow-xl fixed h-full z-50 border-r border-slate-100">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-3 border-t border-slate-100">
              <Link href="/" className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 hover:bg-slate-50 hover:text-amber-700 transition-all duration-200 group">
                <svg className="w-5 h-5 group-hover:text-amber-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
