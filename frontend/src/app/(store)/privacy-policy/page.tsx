  ...
  return (
    <div className="container-shell py-10 sm:py-16 max-w-3xl">
      ...
      <div className="prose prose-sm max-w-none space-y-4" style={{ color: 'var(--brand-text-secondary)' }}>
        <p>Malaika Nest (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) is committed to protecting your privacy. This policy explains how we collect, use and safeguard your personal information when you visit malaikanest.duckdns.org or purchase from our store.</p>
