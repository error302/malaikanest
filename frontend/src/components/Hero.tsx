...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-b from-secondary to-white py-8 md:py-12 lg:py-16 xl:py-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-base md:text-xl text-gray-600 mb-6 sm:mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-6 sm:mb-8">
            <Link 
              href="/" 
              className="w-full sm:w-auto inline-block px-6 sm:px-8 py-3 sm:py-4 bg-cta hover:bg-cta-hover text-white text-base sm:text-lg font-semibold rounded-full transition-all transform hover:scale-105 shadow-lg"
            >
              Shop Now
            </Link>
            <Link 
              href="/dashboard" 
              className="w-full sm:w-auto inline-block px-6 sm:px-8 py-3 sm:py-4 bg-white hover:bg-gray-50 text-gray-800 text-base sm:text-lg font-semibold rounded-full transition-all shadow-md border border-gray-200"
            >
              View Orders
            </Link>
          </div>
          ...
          <div className="mt-6 sm:mt-8 inline-flex items-center gap-2 bg-white/80 backdrop-blur px-4 py-2 rounded-full shadow-sm">
