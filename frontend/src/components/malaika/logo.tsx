...
export function Logo({ variant = 'full', className = '', onLight = false }: LogoProps) {
  const gold = '#8B6914';
  const goldSoft = '#C9A96E';
  const text = onLight ? '#2C1810' : '#2C1810';
  ...
  return (
    <span className={`inline-flex items-center gap-2.5 ${className}`}>
      ...
      >
        ...
        {/* Wings */}
        <path
          d="M10 28 C 6 26, 4 30, 8 33 C 12 36, 18 35, 24 32"
          fill={goldSoft}
          opacity="0.45"
        />
        <path
          d="M38 28 C 42 26, 44 30, 40 33 C 36 36, 30 35, 24 32"
          fill={goldSoft}
          opacity="0.45"
        />
        {/* Baby head */}
        ...
        {/* Body swaddle */}
        <path
          d="M16 32 C 16 27, 20 24, 24 24 C 28 24, 32 27, 32 32 L 32 40 C 32 41.5, 30.5 43, 29 43 L 19 43 C 17.5 43, 16 41.5, 16 40 Z"
          fill={gold}
        />
        {/* Swaddle wrap line */}
        <path
