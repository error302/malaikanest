        ...
        <form onSubmit={handleSubmit} className="p-5 rounded-2xl border mb-6" style={{ background: '#FFFFFF', borderColor: 'var(--brand-border)' }}>
          <div className="space-y-3">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              ...
              <input required aria-label="Your email (not published)" type="email" placeholder="Your email (not published)" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} className="input-warm w-full !pl-4" style={{ background: 'var(--brand-bg-alt)' }} />
            </div>
            <input aria-label="Review title (optional)" placeholder="Review title (optional)" value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} className="input-warm w-full !pl-4" style={{ background: 'var(--brand-bg-alt)' }} />
            <textarea required aria-label="Share your thoughts on this product" placeholder="Share your thoughts on this product…" value={form.body} onChange={(e) => setForm({ ...form, body: e.target.value })} rows={4} className="w-full rounded-xl px-4 py-3 text-sm focus:outline-none" style={{ background: 'var(--brand-bg-alt)', border: '1px solid var(--brand-border)', color: 'var(--brand-text)' }} />
