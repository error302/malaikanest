...
function BrandSection({ b, t }: { b?: Branding; t: any }) {
  return (
...
function LinksSection({ b, t }: { b?: Branding; t: any }) {
  return (
  ...
  return (
    ...
    >
      <div className="container-shell">
        ...
        >
          <BrandSection b={b} t={t} />
          <LinksSection b={b} t={t} />
        </div>
        <BottomBar t={t} />
      </div>
    </footer>
